...
public class SQLOperation
{
    ...
    public SQLOperation()
    {
        SQLstr = @"server=DESKTOP-CQU2A6I;Integrated Security=SSPI;database=Library;";
    ...
    public void SQLconnect() //连接数据库
    {
     ...
     public void add(string into,string values) //增
    {
        SQLconnect();
        //if(sqlconnect != null)
       // {
    ...
    public void update(string TableName,string set,string where)//改
    {
        SQLconnect();
        sqlconnect.Open();
    ...
    public void delete(string TableName,string where) //删
    {
        SQLconnect();
        sqlconnect.Open();
